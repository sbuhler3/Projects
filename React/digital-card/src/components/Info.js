...
export default function Info() {
    return(
        ...
        <a href="mailto:buhler.spencer33@gmail.com">
            <button className="email-but"><img src={email}/><span className="but-text">Email</span></button></a>
            <a href="https://www.linkedin.com/in/spencer-buhler-331623118/" target="_blank">
            <button className="linked-but"><img src={linked}/><span className="but-text">LinkedIn</span></button></a>
        </div>
        </div>
    )
}